...
namespace GameServer.Game.MsgTournaments
{
    ...
    public class MsgPoleDomination
    {
        ...
        public class GuildWarScore
        {
            ...
            {
                ConquerPointsReward = EventsRewards.EventReward("MsgPoleDomination").RewardValue;
            }
        }
        ...
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Pool.ServerMaps[1020].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 830));
        }
        ...
        {
            if (!Core.Features.FeatureRegistry.IsKept("events.poledomination")) return; // [feature-gate]
