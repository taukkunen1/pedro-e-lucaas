...
namespace GameServer.Game.MsgNpc
{
    public enum NpcID : uint
    {
        ...
        ExitElitePk = 168052,
        StartNpc = 4026306,
        // Era 1 - Birth Village (map 1010)
        BirthGuide = 910001,
        BirthMrZeal = 910002,
        BirthBlacksmith = 910003,
        BirthWarehouseman = 910004,
        BirthArmorer = 910005,
        BirthPharmacist = 910006,
        BirthMrNosy = 910007,
        BirthKnowItAll = 910008,
        BirthTaoistStar = 910009,
        BirthOldGeneralYang = 910010,
        PrizeOfficer = 47,
        MarketCpAdmin = 2071,
