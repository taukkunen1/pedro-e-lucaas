...
namespace GameServer.Game.MsgMonster
{
    ...
    Uint16_PLenght = 260;//249;//247;
        ...
        public int random = (int)Role.Core.Random.Next(3, 8);
        ...
        public bool CanRespawn(Role.GameMap map, bool ownerrespawn = false)
        {
            DateTime Now = DateTime.Now;
            if (Family.ID == 8500 && !ownerrespawn)
                return false;
            if (Now > RespawnStamp)
            {
        ...
        public void Respawn(bool SendEffect = true/*, bool ownerrespawn = false*/)
        {
        ...
        public void SendBossSysMesage(string KillerName, int StudyPoints, Game.MsgServer.MsgMessage.ChatMode ChatType = Game.MsgServer.MsgMessage.ChatMode.Center
          , Game.MsgServer.MsgMessage.MsgColor color = Game.MsgServer.MsgMessage.MsgColor.red)
        {
            SendSysMesage("The " + Name.ToString() + " has been destroyed by the team " + KillerName.ToString() + "`s !, and dropped ConquerPoints, Stones, Soul etc..", ChatType, color);
        }
        public void Dead(ServerSockets.Packet stream, Client.GameClient killer, uint aUID, Role.GameMap GameMap, bool CounterKill = false)
        {
            if (Alive)
            {
                ...
                RespawnStamp = DateTime.Now.AddSeconds(14 + Family.RespawnTime);
                if (BlackSpot)
                {
                ...
                if (killer != null && killer.Player != null && !CounterKill)//serverdrop
                {
                    #region citywars
                    /*double RateMultiplied = 1.0;
                    if (killer.Player.MyGuild != null)
                    {
                        if (killer.Player.Map == 1002 && killer.Player.GuildID == MsgSchedules.CityWar.WinnerTC.GuildID) RateMultiplied = 1.5;
                        else if (killer.Player.Map == 1011 && killer.Player.GuildID == MsgSchedules.CityWar.WinnerPC.GuildID) RateMultiplied = 1.5;
                        else if (killer.Player.Map == 1020 && killer.Player.GuildID == MsgSchedules.CityWar.WinnerAC.GuildID) RateMultiplied = 1.5;
                        else if (killer.Player.Map == 1000 && killer.Player.GuildID == MsgSchedules.CityWar.WinnerDC.GuildID) RateMultiplied = 1.5;
                        else if (killer.Player.Map == 1015 && killer.Player.GuildID == MsgSchedules.CityWar.WinnerBI.GuildID) RateMultiplied = 1.5;
                    }*/
                    #endregion
                    #region Saddle
                    if (this.Map == 1013 || this.Map == 1014 || this.Map == 1016)
                    {
                        uint IDSaddle = 723903;
                        if (Family.ID == 2996)//ThiefLeader
                        {
                            for (int x = 0; x < 2; x++)
                            {
                                uint ids = IDSaddle;
                    ...
                    #endregion
                    #region Emerald
                    if (killer.Player.Map == 1000)
                    {
                        if (Family.ID == 15)//HillMonster
                        {
                            if (Role.MyMath.Success(2.0))
                            {
                                uint ids = 1080001;
                                MsgServer.MsgGameItem DataItem = new MsgServer.MsgGameItem();
                                DataItem.ITEM_ID = ids;
                    ...
                    if (killer.Player.Map == 1043)
                    {
                        if (Family.ID == 6006)
                        {
                            if (Role.Core.Rate(6))
                            {
                                ...
                                {
                                    if (killer.Inventory.Add(stream, 721010))
                                    {
                                        killer.Player.MessageBox("You received a Peace Token!", new Action<Client.GameClient>(user => user.Teleport(rX, rY, killer.Player.Map, 0)), null);
                                    }
                                }
                            }
                        }
                    ...
                    if (killer.Player.Map == 1044)
                    {
                        if (Family.ID == 6006)
                        {
                            if (Role.Core.Rate(12))
                            {
                                if (!killer.Inventory.Contain(721011, 1))
                                {
                                    if (killer.Inventory.Add(stream, 721011))
                                    {
                                        killer.Player.MessageBox("You received a Chaos Token!", new Action<Client.GameClient>(user => user.Teleport(rX, rY, killer.Player.Map, 0)), null);
                                    }
                                }
                            }
                        }
                    ...
                    if (killer.Player.Map == 1045)
                    {
                        if (Family.ID == 6006)
                        {
                            if (Role.Core.Rate(3))
                            {
                                ...
                                {
                                    if (killer.Inventory.Add(stream, 721012))
                                    {
                                        killer.Player.MessageBox("You received a Deserted Token!", new Action<Client.GameClient>(user => user.Teleport(rX, rY, killer.Player.Map, 0)), null);
                                    }
                                }
                            }
                        }
                    ...
                    if (killer.Player.Map == 1046)
                    {
                        if (Family.ID == 6006)
                        {
                            if (Role.Core.Rate(12))
                            {
                                ...
                                {
                                    if (killer.Inventory.Add(stream, 721013))
                                    {
                                        killer.Player.MessageBox("You received a Prosperous Token!", new Action<Client.GameClient>(user => user.Teleport(rX, rY, killer.Player.Map, 0)), null);
                                    }
                                }
                            }
                        }
                    ...
                    if (killer.Player.Map == 1047)
                    {
                        if (Family.ID == 6006)
                        {
                            if (Role.Core.Rate(12))
                            {
                                ...
                                {
                                    if (killer.Inventory.Add(stream, 721014))
                                    {
                                        killer.Player.MessageBox("You received a Disturbed Token!", new Action<Client.GameClient>(user => user.Teleport(rX, rY, killer.Player.Map, 0)), null);
                                    }
                                }
                            }
                        }
                    ...
                    if (killer.Player.Map == 1048)
                    {
                        if (Family.ID == 6006)
                        {
                            if (Role.Core.Rate(4))
                            {
                                ...
                                {
                                    if (killer.Inventory.Add(stream, 721015))
                                    {
                                        killer.Player.MessageBox("You received a Calm Token!", new Action<Client.GameClient>(user => user.Teleport(rX, rY, killer.Player.Map, 0)), null);
                                    }
                                }
                            }
                        }
                    ...
                    #endregion
                    /*ushort xx2 = (ushort)(X + Role.Core.Random.Next(1, 3));
                    ushort yy2 = (ushort)(Y + Role.Core.Random.Next(1, 3));
                    if (killer.Map.AddGroundItem(ref xx2, ref yy2, 2))
                    {
                        if (Role.Core.Rate(10, 9999))
                        {
                            if (killer.Player.VipLevel == 6 && killer.Inventory.HaveSpace(1) && killer.StoneLoot)
                            {
                                killer.Inventory.Add(stream, 730002, 1);
                                killer.SendSysMesage("Stone has been autolooted!", MsgMessage.ChatMode.Talk);
                                MsgSchedules.SendSysMesage("Congratulations " + killer.Player.Name + " you obtained by killed monsters Stone +2.", MsgServer.MsgMessage.ChatMode.Center, MsgServer.MsgMessage.MsgColor.white);
                            }
                            else
                            {
                                killer.SendSysMesage("Stone +2 dropped at (" + xx2 + "," + yy2 + ")!", MsgMessage.ChatMode.Talk);
                                DropItemID(killer, 730002, stream);
                                killer.Player.AddMapEffect(stream, xx2, yy2, "accession1");
                                MsgSchedules.SendSysMesage("Congratulations " + killer.Player.Name + " you obtained by killed monsters Stone +2.", MsgServer.MsgMessage.ChatMode.Center, MsgServer.MsgMessage.MsgColor.white);
                            }
                        }
                        if (Role.Core.Rate(10, 9999))
                        {
                            if (killer.Player.VipLevel == 6 && killer.Inventory.HaveSpace(1) && killer.StoneLoot)
                            {
                                killer.Inventory.Add(stream, 730003, 1);
                                killer.SendSysMesage("Stone has been autolooted!", MsgMessage.ChatMode.Talk);
                                MsgSchedules.SendSysMesage("Congratulations " + killer.Player.Name + " you obtained by killed monsters Stone +3.", MsgServer.MsgMessage.ChatMode.Center, MsgServer.MsgMessage.MsgColor.white);
                            }
                            else
                            {
                                killer.SendSysMesage("Stone +3 dropped at (" + xx2 + "," + yy2 + ")!", MsgMessage.ChatMode.Talk);
                                DropItemID(killer, 730003, stream);
                                killer.Player.AddMapEffect(stream, xx2, yy2, "accession1");
                                MsgSchedules.SendSysMesage("Congratulations " + killer.Player.Name + " you obtained by killed monsters Stone +3.", MsgServer.MsgMessage.ChatMode.Center, MsgServer.MsgMessage.MsgColor.white);
                            }
                        }
                        if (Role.Core.Rate(10, 9999))
                        {
                            if (killer.Player.VipLevel == 6 && killer.Inventory.HaveSpace(1) && killer.StoneLoot)
                            {
                                killer.Inventory.Add(stream, 730004, 1);
                                killer.SendSysMesage("Stone has been autolooted!", MsgMessage.ChatMode.Talk);
                                MsgSchedules.SendSysMesage("Congratulations " + killer.Player.Name + " you obtained by killed monsters Stone +4.", MsgServer.MsgMessage.ChatMode.Center, MsgServer.MsgMessage.MsgColor.white);
                            }
                            else
                            {
                                killer.SendSysMesage("Stone +4 dropped at (" + xx2 + "," + yy2 + ")!", MsgMessage.ChatMode.Talk);
                                DropItemID(killer, 730004, stream);
                                killer.Player.AddMapEffect(stream, xx2, yy2, "accession1");
                                MsgSchedules.SendSysMesage("Congratulations " + killer.Player.Name + " you obtained by killed monsters Stone +4.", MsgServer.MsgMessage.ChatMode.Center, MsgServer.MsgMessage.MsgColor.white);
                            }
                        }
                    ...
                    if (killer.FruitsMobs > killer.MaxFruits)
                    {
                        ...
                        killer.MaxFruits = Role.Core.Random.Next(100, 300);
                    }
                    #endregion
                    ...
                    if (killer.CityMobs > killer.MaxCity)
                    {
                        ...
                        switch (rand2)
                        {
                            ...
                            case 3:
                                {
                                    DropItemID(killer, 710968, stream);
                        ...
                        killer.MaxFruits = Role.Core.Random.Next(100, 250);
                    }
                    ...
                    if (killer.Player.Map == 44461)
                    {
                        if (Family.ID == 452373)
                        {
                            ...
                            killer.Teleport(killer.Player.X, killer.Player.Y, 44462, Pool.ServerMaps[44462].GenerateDynamicID());
                    ...
                    else if (killer.Player.Map == 44462)
                    {
                        ...
                        killer.Teleport(killer.Player.X, killer.Player.Y, 44463, Pool.ServerMaps[44463].GenerateDynamicID());
                    }
                    ...
                    else if (killer.Player.Map == 3935)
                    {
                        ...
                        if (killer.Player.QuestGUI.CheckQuest(35007, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                        {
                            if (killer.Player.QuestGUI.CheckQuest(35007, MsgQuestList.QuestListItem.QuestStatus.Finished) == false)
                            {
                                ...
                                {
                                    uint Points = (uint)Pool.GetRandom.Next(2, 6);
                    ...
                    else if (killer.Player.Map == 1780)
                    {
                        if (Family.ID == 12314463)
                        {
                            ...
                            Database.ItemType.DBItem DBItem;
                            if (Pool.ItemsBase.TryGetValue(721714, out DBItem))
                            {
                                DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                            }
                            DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 18)//birdman
                        {
                            if (Family.ID == 18)//bird man
                            {
                                if (Role.Core.Rate(10))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(729094, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 17)//blade ghost
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1494, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                ...
                                if (Role.Core.Rate(25))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711406, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 75)
                        {
                            if (killer.Player.QuestGUI.CheckQuest(1797, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(45))
                                {
                                    if (killer.Inventory.HaveSpace(1))
                                    {
                                        byte rand = (byte)Pool.GetRandom.Next(0, 3);
                                        switch (rand)
                                        {
                                            case 0:
                                                {
                        ...
                        if (Family.ID == 51)
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1480, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                ...
                                killer.CreateBoxDialog("You`ve~killed~the~Rock~Monster~and~obtained~a~Colorful~Stone.");
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711349, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1481, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                ...
                                killer.CreateBoxDialog("You`ve~killed~the~Rock~Monster~and~obtained~a~Grindstone.");
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711399, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        else if (Family.ID == 74)
                        {
                            if (Role.Core.Rate(5))
                            {
                                ...
                                killer.CreateBoxDialog("You`ve~killed~the~Hill~Monster~and~received~a~Secret~Letter.");
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(720975, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        else if (Family.ID == 15)
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1467, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                ...
                                killer.CreateBoxDialog("You`ve~killed~the~Hill~Monster~and~received~a~Hammer.");
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711344, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1474, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                ...
                                killer.CreateBoxDialog("You`ve~killed~the~monster~and~received~a~Heavy~Axe.");
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711415, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        else if (Family.ID == 73)
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1461, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711343, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 72)//Snakeman lev 63
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1341, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(720858, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1334, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(720855, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 13)//Snakeman
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1341, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(720857, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1333, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(720854, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 71)
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1328, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(720850, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 12)// thunder
                        {
                            if (killer.Player.QuestGUI.CheckQuest(1327, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(20))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(711353, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
                        ...
                        if (Family.ID == 10)//macaque
                        {
                            ...
                            if (killer.Player.QuestGUI.CheckQuest(1311, MsgQuestList.QuestListItem.QuestStatus.Accepted))
                            {
                                if (Role.Core.Rate(30))
                                {
                                    ...
                                    Database.ItemType.DBItem DBItem;
                                    if (Pool.ItemsBase.TryGetValue(729976, out DBItem))
                                    {
                                        DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                    }
                                    DataItem.Color = Role.Flags.Color.Red;
 ...
 killer.Player.QuestGUI.SendAutoPatcher("Congratulations!~You~found~an~invitation~to~the~Treasure~Appraisal~Meeting.~Open~your~inventory~and~read~it.", ActiveQuest.FinishNpcId.Map, ActiveQuest.FinishNpcId.X, ActiveQuest.FinishNpcId.Y, ActiveQuest.FinishNpcId.ID);
    ...
    killer.Player.QuestGUI.SendAutoPatcher("You`ve~collected~the~bags~of~10~Bandits.~Hurry~to~report~back~to~the~ForestGuvernor!", ActiveQuest.FinishNpcId.Map, ActiveQuest.FinishNpcId.X, ActiveQuest.FinishNpcId.Y, ActiveQuest.FinishNpcId.ID);
                ...
                if (killer != null)
                {
                        ...
                        {
                            {
                                ...
                                Database.ItemType.DBItem DBItem;
                                if (Pool.ItemsBase.TryGetValue(3004181, out DBItem))
                                {
                                    DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                }
                                DataItem.Color = Role.Flags.Color.Red;
                    ...
                    if (Map == 3846)
                    {
                        ...
                        if (Family.ID == 20300)//nemesys
                        {
                            ...
                            for (int x = 0; x < 7; x++)
                            {
                                ...
                                Database.ItemType.DBItem DBItem;
                                if (Pool.ItemsBase.TryGetValue(Database.ItemType.DragonBall, out DBItem))
                                {
                                    DataItem.Durability = DataItem.MaximDurability = DBItem.Durability;
                                }
                                DataItem.Color = Role.Flags.Color.Red;
                                ushort xx = (ushort)Pool.GetRandom.Next(X - 7, X + 7);
                                ushort yy = (ushort)Pool.GetRandom.Next(Y - 7, Y + 7);
                                if (killer.Map.AddGroundItem(ref xx, ref yy, 3))
                                {
                                    MsgFloorItem.MsgItem DropItem = new MsgFloorItem.MsgItem(DataItem, xx, yy, MsgFloorItem.MsgItem.ItemType.Item, 0, DynamicID, Map, killer.Player.UID, true, GMap);
                    ...
                    //                                {
                    //                                    uint IDDrop = DropSpecialItems[Pool.GetRandom.Next(0, DropSpecialItems.Length)];
                    //                                    DropItem(stream, killer.Player.UID, killer.Map, DropSpecialItems[Pool.GetRandom.Next(0, DropSpecialItems.Length)], xx, yy, MsgFloorItem.MsgItem.ItemType.Item, 0, false, 0);

                    //                                    string drop_name = Constants.ItemsBase[IDDrop].Name;
                    //#if Arabic
                    ...
                    if (Boss > 0 && Family.ID == 213883)//chaos Guard
                    {
                        ...
                        , 120049};
                        {
                            uint ItemId = ItemsIDS[Pool.GetRandom.Next(0, ItemsIDS.Length)];
                        ...
                        for (int x = 0; x < 5; x++)
                        {
                            ...
                            DataItem.Color = Role.Flags.Color.Red;
                            ushort xx = (ushort)Pool.GetRandom.Next(X - 5, X + 5);
                            ushort yy = (ushort)Pool.GetRandom.Next(Y - 5, Y + 5);
                            if (killer.Map.AddGroundItem(ref xx, ref yy, 3))
                            {
                                MsgFloorItem.MsgItem DropItem = new MsgFloorItem.MsgItem(DataItem, xx, yy, MsgFloorItem.MsgItem.ItemType.Item, 0, DynamicID, Map, killer.Player.UID, true, GMap);
                    ...
                    ////if (Boss > 0 && (Family.ID == 20136 || Family.ID == 20135 || Family.ID == 20021 || Family.ID == 20020))
                    ////{
                    ...
                    ////        }
                    ////    }
                    ////    List<uint> DropIems2 = Family.ItemGenerator.GenerateRefineryItems((ushort)Pool.GetRandom.Next(1, 4));
                    ...
                    {
                        Pool.LavaBeast.Add(new coords(Family.LavaX, Family.LavaY) { });
                        ...
                        for (int x = 0; x < 3; x++)
                        {
                            ...
                            if (killer.Map.AddGroundItem(ref xx, ref yy))
                            {
                                DropItem(stream, killer.Player.UID, killer.Map, id, xx, yy, Game.MsgFloorItem.MsgItem.ItemType.Item, 0, false, 0, null, null, true);
                            }
                        }
                        #endregion
                        if (random == 1)
                        {
                            #region SoulP1
                            List<uint> DropIems2 = Family.ItemGenerator.GenerateSoulsItems(1);
                        ...
                        {
                            #region SoulP2
                            List<uint> DropIems33 = Family.ItemGenerator.GenerateSoulsItems(2);

                            foreach (var ids in DropIems33)
                            {
                                MsgServer.MsgGameItem DataItem = new MsgServer.MsgGameItem();
                                DataItem.ITEM_ID = ids;
                                Database.ItemType.DBItem DBItem;
                        ...
                        {
                            #region SoulP3
                            List<uint> DropIems3 = Family.ItemGenerator.GenerateSoulsItems(3);

                            foreach (var ids in DropIems3)
                            {
                                MsgServer.MsgGameItem DataItem = new MsgServer.MsgGameItem();
                                DataItem.ITEM_ID = ids;
                                Database.ItemType.DBItem DBItem;
                    ...
                    if (Boss > 0 && Family.ID == 6643)
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            xx = (ushort)Pool.GetRandom.Next(X - 7, X + 7);
                            yy = (ushort)Pool.GetRandom.Next(Y - 7, Y + 7);
                            if (i < 1)
                            {
                                if (killer.Map.AddGroundItem(ref xx, ref yy))
                                {
                                    DropItem(stream, killer.Player.UID, killer.Map, 1088000, xx, yy,
                                        Game.MsgFloorItem.MsgItem.ItemType.Item, 0, false, 0);
                                }
                            }
                            uint Money_Itemid = 0;
                            uint money_value = Family.ItemGenerator.GenerateGoldBoss(out Money_Itemid, 250000);

                            if (killer.Map.AddGroundItem(ref xx, ref yy))
                            {
                                DropItem(stream, killer.Player.UID, killer.Map, Money_Itemid, xx, yy, Game.MsgFloorItem.MsgItem.ItemType.Money, money_value, false, 0);
                            }
                        }
                        xx = (ushort)Pool.GetRandom.Next(X - 7, X + 7);
                        yy = (ushort)Pool.GetRandom.Next(Y - 7, Y + 7);
                    ...
                    if (Family.ID == 8419) // WaterDevil
                    {
                        ...
                        if (killer.Map.AddGroundItem(ref xx, ref yy))
                        {
                            DropItem(stream, killer.Player.UID, killer.Map, Database.ItemType.DragonBall, xx, yy,
                                Game.MsgFloorItem.MsgItem.ItemType.Item, 0, false, 0, null, null, true);
                        }
                    }
                    if ((Family.Settings & MonsterSettings.DropItemsOnDeath) == MonsterSettings.DropItemsOnDeath)
                    {
                        if (DropMob.Checkup(stream, killer, this))
                            return;
                    }
                }
            }
            ...
            , uint amount, bool special, byte ID_Quality, Client.GameClient user = null, Database.ItemType.DBItem DBItem = null, bool CHECKITEM = false)
        {
            ...
            if (DataItem.ITEM_ID == 730004)
            {
                DataItem.Plus = 4;
            }
            if (DataItem.ITEM_ID == 730005)
            {
                DataItem.Plus = 5;
            }
            if (DataItem.ITEM_ID == 730006)
            {
                DataItem.Plus = 6;
            }
            if (DataItem.ITEM_ID == 730007)
            {
                DataItem.Plus = 7;
            }
            if (DataItem.ITEM_ID == 730008)
            {
                DataItem.Plus = 8;
            }
        ...
        public void AddFadeAway(long ticks, Role.GameMap map)
        {
            if (!Alive)
            {
                DateTime timer = new DateTime(ticks);
        ...
        public unsafe bool RemoveView(long ticks, Role.GameMap map)
        {
        ...
        public void DropItemID(Client.GameClient killer, uint itemid, ServerSockets.Packet stream, byte range = 3, bool CHECKITEM = false, int mins = 0)
        {
            ...
            {
                MsgFloorItem.MsgItem DropItem = new MsgFloorItem.MsgItem(DataItem, xx, yy, MsgFloorItem.MsgItem.ItemType.Item, 0, DynamicID, Map, killer.Player.UID, true, GMap);
                if (itemid == 722057 || itemid == 720667 || itemid == 823055 || itemid == 720662 || itemid == 729479 || itemid == 722057 || itemid == 723342 || itemid == 1088000 || itemid == 720891 || itemid == 727100)
                {
                    if (itemid == 1088000)
                    {
                        ActionQuery action2;
        ...
        bool ConfirmBoss()
        {
            if (Family.ID == 20070 || Family.ID == 20160 || Family.ID == 3130 || Family.ID == 4145 || Family.ID == 20136 || Family.ID == 3739 || Family.ID == 20135 || Family.ID == 3738 || Family.ID == 20021 || Family.ID == 20020 || Family.ID == 3130) return true;
            return false;
        }
        internal unsafe void DistributeBossPoints()
        {
            if (ConfirmBoss())
            {
                ...
                MsgSchedules.SendSysMesage("Player " + scores.Value.Name + " has made the most damage on the " + Name + " and gained 1 boss point.", MsgServer.MsgMessage.ChatMode.System, MsgServer.MsgMessage.MsgColor.red);
                GameClient player;
                if (Pool.GamePoll.TryGetValue(scores.Key, out player))
                {
