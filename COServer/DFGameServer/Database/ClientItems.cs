    ...
    public class ClientItems
    {
        public struct DBItem
        {
            ...
            public Game.MsgServer.MsgGameItem GetDataItem()
            {
                ...
                DataItem.Suspicious = 0; // Era 1: itens suspeitos vieram no Patch 5022
                DataItem.Locked = Game.MsgServer.MsgItemLock.LockEnabled ? Locked : (byte)0; // core.itemlock
                DataItem.PlusProgress = PlusProgress;
                DataItem.Inscribed = global::Core.Features.FeatureRegistry.IsKept("social.arsenal") ? Inscribed : (byte)0; // social.arsenal (Patch 5180)
                ...
                DataItem.Fake = Fake;
                DataItem.UnLockTimer = Game.MsgServer.MsgItemLock.LockEnabled ? UnLockTimer : 0; // core.itemlock
