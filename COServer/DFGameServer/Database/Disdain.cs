...
namespace GameServer.Database
{
    ...
    public class Disdain
    {
        ...
        {
            string[] baseText = File.ReadAllLines(Path.Combine(ServerConfig.DbLocation, "cq_disdain.txt"));
        ...
        {
            return damage; // Remove this line if you need apply a BP Difference in damage and discomment the next 5 lines
